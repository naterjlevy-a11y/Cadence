...
final class UserPreferences: ObservableObject {
    ...
    /// `auto` = Mellotron Cloud if signed in, else BYOK, else Apple;
    ...
    /// Default `false`: Mellotron's built-in WKWebView popup (small,
...
extension Notification.Name {
    static let preferencesDidChange = Notification.Name("MellotronPreferencesDidChange")
    static let mellotronOpenPermissionRepair = Notification.Name("MellotronOpenPermissionRepair")
}
