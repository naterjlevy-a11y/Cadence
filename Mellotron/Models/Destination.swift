...
/// How Mellotron should reach a destination.
...
/// Mellotron will open the matching URL instead of the destination's default.
...
/// Describes a single destination Mellotron knows how to route to.
struct Destination: Codable, Identifiable, Hashable {
    ...
    /// When true, opening this destination shows it in Mellotron's floating
