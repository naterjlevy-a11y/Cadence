...
private struct WelcomeStep: View {
    ...
    var body: some View {
        StepShell(
            ...
            subtitle: "Hold a key. Speak naturally. Release. Mellotron transcribes, polishes, and pastes — Claude, ChatGPT, Docs, anywhere.",
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                if auth.isSignedIn && !auth.isAnonymous {
                    if auth.plan == "pro" {
                        Text("You're on Mellotron Pro — unlimited dictation is active.")
                            .font(.melloBody(11))
...
private struct AccountTile: View {
    ...
    private var secondary: String {
        ...
        if auth.plan == "pro" { return "Mellotron Pro — unlimited dictation." }
    ...
    var body: some View {
        StepShell(
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                StepRow(number: 3, title: "Release to send", description: "Mellotron opens the destination, cleans up the text, and pastes.")
...
private struct PermissionsStep: View {
    ...
    var body: some View {
        StepShell(
            ...
            subtitle: "Mellotron needs four macOS permissions. Grant each one, then continue — you can fix stale toggles later with Permission Repair.",
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                RelaunchCard(reason: "After Accessibility or Input Monitoring, macOS may need Mellotron to relaunch once.")
            }
        }
    }
}
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Button {
                ...
                Label("Restart Mellotron now", systemImage: "power")
            }
            .buttonStyle(.borderedProminent)
            .controlSize(.small)
        }
...
private struct PushToTalkKeyStep: View {
    ...
    var body: some View {
        StepShell(
            ...
            subtitle: "Mellotron can either record while you hold a key, or toggle on a quick double-tap. Pick whichever fits your hands.",
            primaryLabel: "Save",
            onPrimary: onContinue
        ) {
            VStack(alignment: .leading, spacing: 14) {
...
private struct DoneStep: View {
    ...
    var body: some View {
        StepShell(
            title: "You're *ready*.",
            subtitle: "Hold your key anywhere on your Mac, say a destination like “Hey Claude,” then dictate naturally. The Mellotron icon lives in your menu bar — click it for Settings, history, or to send feedback.",
            primaryLabel: "Start using Mellotron",
            onPrimary: onClose
        ) {
            VStack(alignment: .leading, spacing: 12) {
...
private struct ExampleBox: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            row(label: "Mellotron pastes", text: cleaned, faded: false)
        }
        .padding(12)
        .background(
        ...
        if isInApps {
            ...
            HStack(alignment: .top, spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    Text("Install Mellotron in /Applications")
                        .font(.system(size: 12, weight: .semibold))
