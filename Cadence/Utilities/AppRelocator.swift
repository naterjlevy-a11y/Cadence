...
enum AppRelocator {
    ...
    /// Other copies of Cadence.app on disk that might confuse TCC.
    ...
    static func duplicateInstallations() -> [URL] {
        ...
        let inApps = URL(fileURLWithPath: "/Applications/Cadence.app")
        ...
        if let enumerator = fm.enumerator(atPath: derived) {
            for case let path as String in enumerator {
                if path.hasSuffix("/Cadence.app") || path == "Cadence.app" {
