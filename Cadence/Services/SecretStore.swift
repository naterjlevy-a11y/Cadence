...
///   2. `.env` file               — `~/.config/cadence/.env`
///   3. macOS Keychain            — `com.natelevy.cadence` / `groq`
...
final class SecretStore {
    ...
    private let keychainService = "com.natelevy.cadence"
    ...
    enum Source: String {
        ...
        case dotEnv       = "~/.config/cadence/.env"
    ...
    enum Storage: String, CaseIterable, Identifiable {
        ...
        var displayName: String {
            ...
            case .dotEnv:       return ".env file (~/.config/cadence/.env)"
    ...
    // MARK: - Supabase session (Cadence Cloud)
    //
    ...
    // "Cadence wants to use your confidential information" prompt whenever
    ...
    private var sessionFileURL: URL {
        ...
        return base.appendingPathComponent("Cadence/session.json")
    }
    ...
    var dotEnvPath: URL {
        ...
        return home.appendingPathComponent(".config/cadence/.env")
    }
    ...
    private func writeToDotEnv(_ key: String, value: String) throws {
        ...
        if FileManager.default.fileExists(atPath: url.path),
           let existing = try? String(contentsOf: url, encoding: .utf8) {
            ...
            lines = [
                "# Cadence secrets — owned by you. Format: KEY=value, one per line.",
