...
struct SignInView: View {
    ...
    private var subtitle: String {
        ...
        case .signInPassword:
            return "Enter the email and password for your Cadence account."
        case .codeEntry:
    ...
    private var pickerStage: some View {
        VStack(spacing: 10) {
            ProviderButton(provider: .apple, title: "Apple", action: { auth.signInWithProvider(.apple) }) // browser flow while Apple propagates native SIWA; revert to auth.signInWithApple() later
